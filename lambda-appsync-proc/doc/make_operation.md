...
Use it at the root of a crate where you plan to implement your operations using the [macro@appsync_operation] attribute macro.
...
## Called at the crate root

The [macro@appsync_operation] attribute macro depends on being able to add impl crate::Operation {...}
blocks. You **MUST** use `make_operation!` (or [make_appsync!]) at the crate root in order to use
`#[appsync_operation(...)]`.

## AppSync types in Scope
...
1. **Same scope**: Call [make_types!] in the same scope as `make_operation!`
